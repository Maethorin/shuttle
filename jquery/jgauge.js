...
function jGauge()
{
	...
	function updateRange()
	{
		...
		if (canvas.getContext) {
            ...
            for (var range in jG.ranges) {
                ctx.strokeStyle = jG.ranges[range].color;
                ctx.lineWidth = jG.ranges[range].thickness;
                ...
                ctx.arc(jG.centerX + jG.needle.xOffset,
                    ...
                    jG.ranges[range].radius,
                    (Math.PI / 180) * jG.ranges[range].start,
                    (Math.PI / 180) * jG.ranges[range].end,
                    false);
